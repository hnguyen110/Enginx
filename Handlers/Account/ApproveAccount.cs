...
{
    public class Command : IRequest<ApproveAccountDTO>
    {
        public string? Id { get; set; }
    }

    public class Handler : IRequestHandler<Command, ApproveAccountDTO>
    {
        ...
        public async Task<ApproveAccountDTO> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<Models.Account, ApproveAccountDTO>(record);
        }
    }
}